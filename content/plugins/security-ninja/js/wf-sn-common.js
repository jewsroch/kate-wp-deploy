...
jQuery(document).ready(function($){
  ...
  $('#sn_hide_core_ad').click(function(e){
    e.preventDefault();
  ...
  $('#sn_hide_schedule_ad').click(function(e){
    e.preventDefault();
  ...
  // hide logger add-on tab
  $('#sn_hide_logger_ad').click(function(e){
    e.preventDefault();
    var data = {action: 'sn_hide_logger_tab'};
